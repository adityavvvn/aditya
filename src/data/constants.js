export const Bio = {
  ...
  github: "https://github.com/adityavvvn",
  resume: "https://drive.google.com/file/d/1n_3zEdUZEDm0XilLlPgIZJOt4xxK0y1Q/view?usp=drive_link",
  linkedin: "https://www.linkedin.com/in/v-v-v-n-udayaditya-589706157",
  insta: "https://www.instagram.com/adityavvvn/",
};
...
export const experiences = [
  {
    ...
    desc: "Working on LMS (learning Management System) Platform, managing DevOps, and streamlining the process.",
    skills: [
      "MongoDB",
      "Express",
      "React",
...
export const projects = [
  ...
  {
    id: 2,
    title: "Urban Harmony: The Vital Role of Parking Slot Management in City Life",
  ...
  {
    id: 3,
    title: "Early Detection and Prevention of Chronic Kidney Disease: A Predictive and Integrative Approach",
  ...
  {
    id: 10,
    title: "Enhanced Patient Experience: Robotics, Voice AI, and Chatbot Integration in Healthcare",
    date: "Jun 2023 - Jul 2023",
    description:
  ...
  {
    id: 4,
    title: "Vehicle Anomaly Detection Using Machine Learning",
    date: "Jul 2021",
    description:
  ...
  {
    id: 6,
    title: "Fine-Grained Sentiment Detection in Code-Mixed Indian Languages using Hierarchical Multilingual Contextual Embeddings",
    date: "Jun 2021",
    description:
  ...
  {
    id: 7,
    title: "Amrita Digital Course File System",
  ...
  {
    id: 9,
    title: "SkillPlot - Visual Resume & Career Mapper",
    date: "Jan 2021",
    description:
      "A Face recognition python app made with OpenCV. It uses face_recognition library to detect faces. It uses the webcam to detect faces. It also has a search bar to search for a particular face.",
    image:
